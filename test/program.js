...
contract("FragmentTemplate", accounts => {
  ...
  it("should upload a template", async () => {
    ...
    await contract.setVaultLogic(vaultContract.address, { from: "0x7F7eF2F9D8B0106cE76F66940EF7fc0a3b23C974" });
  ...
  it("should rez a entity from template", async () => {
    const contract = await nft.deployed();
    const tx = await contract.rez(tokenTwo, "Token Two", "TWO", false, 10, { from: accounts[1] });
    console.log(tx);
    fragmentOneEntity = tx.logs[1].args.entityContract;
    const entity = new web3.eth.Contract(entityNft.abi, fragmentOneEntity);
    const template = await entity.methods.getTemplate().call();
    assert.equal(template, tokenTwo);
  ...
  it("should not rez a entity from template", async () => {
    ...
    try {
      await contract.rez(tokenTwo, "Token Two", "TWO", true, 10, { from: accounts[1] });
    } catch (e) {
  ...
  it("should mint an NFT from entity as owner", async () => {
    ...
    const tx = await entity.methods
      .upload("0x9f668b20cfd24cdbf9e1980fa4867d08c67d2caf8499e6df81b9bf0b1c97287d", empty, 1)
      .send({ from: accounts[1], gas: 500000 });
    assert.equal(tx.events.Upload.raw.data, "");
  });
  ...
  it("should mint one from entity as buyer", async () => {
    ...
    const tx = await entity.methods
      .mint(signature, "0x9f668b20cfd24cdbf9e1980fa4867d08c67d2caf8499e6df81b9bf0b1c97287d", empty, 1)
      .send({ from: accounts[4], gas: 800000, value: web3.utils.toWei("0.1", "ether") });
    assert.equal(tx.events.Upload.raw.data, "");
