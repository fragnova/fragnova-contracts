...
/// @title A Proxy Contract for the Rez Smart Contract
contract RezProxy is Proxy {
    ...
    /// @dev Sets the address in storage slot `_IMPLEMENTATION_SLOT` to `newImplementation`
    /// @param newImplementation The Impleentation Contract Address
    ...
    /// @notice Returns the address of the actual Rez Contract
